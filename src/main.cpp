      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          bool left_line_empty = true;
          bool right_line_empty = true;
          
          iMax = sensor_fusion.size();
          ...
          if(prev_size < 2){
            ...
            ref_vel = distance(ref_x,ref_y,ref_x_prev, ref_y_prev)/0.02;
